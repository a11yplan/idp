...
export function generateStaticParams() { 
  return Promise.resolve(
    [{"slug":["notion-magic-link"]},{"slug":["plaid-verify-identity"]},{"slug":["stripe-welcome"]},{"slug":["vercel-invite-user"]},{"slug":["auth","change-email"]},{"slug":["auth","confirmation"]},{"slug":["auth","invite"]},{"slug":["auth","magic-link"]},{"slug":["auth","reset-password"]}]
  );
}